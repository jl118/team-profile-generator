...
describe("Manager", () => {
    it("Should create an object with name, id, email, and office number", () => {
        expect(new Manager("Randall Boggs", 51, "number1scarer@gmail.com", 440)).toEqual({ name: 'Randall Boggs', id: 51, email: 'number1scarer@gmail.com', officeNumber: 440 });
    });
    ...
    it("should be able to call getOfficeNumber and get the manager's office number", () => {
        expect(new Manager("Randall Boggs", 51, "number1scarer@gmail.com", 440).getOfficeNumber()).toBe(440);
    });
