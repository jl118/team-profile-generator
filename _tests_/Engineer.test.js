...
describe("Engineer", () => {
    it("Should create an object with name, id, email, and github", ()=> {
        expect(new Engineer("James P. Sullivan", 193, "sullen.berger@gmail.com", "sully")).toEqual({ name: 'James P. Sullivan', id: 193, email: 'sullen.berger@gmail.com', github: 'sberger' });
    });
